...
import { Jumbotron, Container, Image, Row, Col, Card} from 'react-bootstrap'

class Index extends Component{
    render(){
        return(
            <div>
                <Jumbotron fluid='true' className='bg-light pt-5 text-center' style={{height:'90vh'}}>
                    <Container className='text-center py-5 px-5' style={{height:'90%'}}>
                        <div>
                            ...
                            <hr/>
                            <h1 className='text-muted animate__animated animate__tada animate__delay-1s'>Fullstack JavaScript Developer</h1>
                            <Image src={require('../images/avatar.png')} width={200}/>
                        </div>
                    </Container>
                    <a href='#skills'>
                        <svg class="bi bi-arrow-down-circle animate__animated animate__bounce animate__repeat-2 animate__delay-2s" width="5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Container id='skills' className='py-5' style={{height:'100vh'}}>
